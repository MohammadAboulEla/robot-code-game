...
export const DebuggerPanel: React.FC<DebuggerPanelProps> = ({
  ...
  if (isIdle) {
    return (
      <div className="border border-[#3e382d] bg-[#f4efe1] p-4 flex flex-col items-center justify-center text-center h-[240px]">
  ...
  return (
    <div className="border border-[#3e382d] bg-[#f4efe1] shadow-sm flex flex-col text-xs font-mono">
      ...
      {/* Main debug workspace split layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[#3e382d] h-[200px]">
